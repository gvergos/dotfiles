...
-- My local variable to control brightness with xrandr
local brightness_amount = 0.5
...
awful.util.tagnames = { "  1    ", "  2    ", "  3    ", "  7  ",  "  8    ", "  9   "}
...
globalkeys = mytable.join(
    ...
    awful.key({ }, "XF86MonBrightnessUp", function ()
                if brightness_amount < 1 then
                    brightness_amount = brightness_amount + 0.1
                end
                os.execute(string.format("xrandr --output eDP-1 --brightness %f", brightness_amount))
                end,
              {description = "+10%", group = "hotkeys"}),

    awful.key({ }, "XF86MonBrightnessDown", function ()
                if brightness_amount > 0.1 then
                    brightness_amount = brightness_amount - 0.1
                end
                os.execute(string.format("xrandr --output eDP-1 --brightness %f", brightness_amount))
...
for v, i in pairs({1, 2, 3, 7, 8, 9 }) do
